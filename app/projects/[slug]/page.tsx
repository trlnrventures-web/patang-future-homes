...
export default async function ProjectDetail({ params }: Props) {
  ...
  const related = projects
    ...
    .slice(0, 5);
  const developerInitials = project.developer.name
    .split(" ")
    .map((w) => w[0])
    .join("")
    .slice(0, 2)
    ...
    <>
      ...
      <div className="bg-background">
        <div className="mx-auto max-w-7xl px-5 pt-28 pb-16 lg:px-8 lg:pt-32 lg:pb-24">
          ...
          {/* ================= 3. QUICK FACTS ================= */}
          <div className="mt-6">
            <div className="flex gap-2.5 overflow-x-auto pb-1 [-webkit-overflow-scrolling:touch] [scrollbar-width:thin] lg:flex-wrap lg:overflow-visible">
              {quickFacts.map((fact) => (
                <div
                  key={fact.label}
                ...
                <div className="mt-6 overflow-hidden rounded-2xl bg-primary text-white">
                  <div className="relative overflow-hidden px-8 py-9 lg:px-10">
                    ...
                    <div className="relative flex flex-wrap items-center gap-6">
                      <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-white/10 text-2xl font-bold text-accent ring-1 ring-white/20">
                        {developerInitials}
                      </div>
          ...
          {related.length > 0 && (
            <section className="mt-20">
              ...
              />
              <div className="mt-6 flex snap-x snap-mandatory gap-5 overflow-x-auto pb-4 [-webkit-overflow-scrolling:touch] [scrollbar-width:thin]">
                {related.map((p) => (
                  <Link
                    key={p.slug}
